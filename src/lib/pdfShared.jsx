...
// src/lib/pdfShared.jsx
// Socle commun des documents PDF artisan (rapport thermique, synthèse DPE, planning hebdo) :
// palette (deutan — bleu/ambre/slate, JAMAIS rouge/vert, règle produit R12), formatters
// PDF-safe, cartouche société. Les footers restent propres à chaque document (texte métier).
// Le module Solaire garde son propre socle (palette jaune PV, formatters dédiés).
//
