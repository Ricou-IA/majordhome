...
// Modale nom client (+ commentaire optionnel) — réutilisée pour l'enregistrement
// d'une simulation ET pour la génération de l'étude PDF (showComment=false).
...
export default function SaveSimulationModal({
  ...
  // Réinitialise les champs à chaque ouverture (pré-rempli si simulation rechargée)
  useEffect(() => {
    if (open) {
