/**
 * QuoteModal.jsx - Majord'home Artisan
 * ============================================================================
 * Modale compacte pour qualifier l'envoi d'un devis.
...
export const QuoteModal = ({ isOpen, onClose, onConfirm, loading = false, defaultAmount = '' }) => {
      ...
      <div className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-[61] w-full max-w-sm bg-white rounded-xl shadow-2xl animate-in fade-in zoom-in-95 duration-150">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500 outline-none transition-colors"
              />
            </div>
          </div>
        ...
        <div className="flex items-center justify-end gap-2 px-5 py-3 border-t bg-gray-50 rounded-b-xl">
          ...
          <Button
            ...
            disabled={loading}
            className="min-h-[36px] bg-orange-600 hover:bg-orange-700 text-white"
          >
