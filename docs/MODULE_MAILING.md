...
- Compteur de segments (GSM-7 160/segment, UCS-2 70/segment dès un caractère hors alphabet : `ê â î ô û`, apostrophe typographique `’`, guillemets) + case « Retirer les accents à l'envoi » (= `deburr`, appliqué au SMS **et** au WhatsApp par l'edge).
